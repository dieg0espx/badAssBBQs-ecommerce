        ...
        <div className="w-full flex items-center justify-center">
          <div className="w-full h-[230px] bg-red text-white rounded-lg p-6 shadow-2xl relative">
            ...
            <div className="absolute bottom-4 left-6">
              ...
              <div className="text-sm font-medium">{toUppercase(props.name)}</div>
            </div>
          </div>
        </div>
              ...
              <div className="flex space-x-4 mb-[30px]">
                <div className="w-3/4">
                  ...
                  <input
                    ...
                    className="w-full border-gray-300 rounded border px-4 py-2 text-sm focus:ring-blue-500 focus:border-blue-500"
                    maxLength={19}
                    required
                  />
                </div>
